...
type SchemaSerice struct {
	columnRepo *repository.ColumnRepository
	fkRepo     *repository.FKEdgesRepository
}

func NewSchemaSerice(columnRepo *repository.ColumnRepository, fkRepo *repository.FKEdgesRepository) *SchemaSerice {
	return &SchemaSerice{
...
func (s *SchemaSerice) ApplyDDL(ctx context.Context, projectId string, ddl string) error {
